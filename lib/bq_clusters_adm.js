  ...
  self.mysqlPool.getConnection(function(err, mysqlConn) {
    ...
    async.series([
      ...
      function(cb) {
        ...
        mysqlConn.query("INSERT INTO consumers (consumer_id, tenant_id, tenant_name, consumer_name, cluster, topic_id, create_time, enabled) VALUES (?,?,?,?,?,?,now(),?)",
                         [id, consumer.tenant_id, consumer.tenant_name, consumer.name, cluster, consumer.topic_id,consumer.enabled], cb);
      },
      function(cb) {
