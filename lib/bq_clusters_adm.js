      ...
      function(topics_db, cb) {
        ...
        topics_db.forEach(function(topic) {
          var data = {topic_id: topic.topic_id, cluster: topic.cluster,
            ttl: topic.ttl, enabled: topic.enabled, max_new_messages_per_seccon: topic.max_new_messages_per_seccond,
            consumers: []};
          topics.push(data);
      ...
      data.forEach( function(e){
        if(e.consumer_id)
          consumers.push({topic_id: e.topic_id, consumer_id: e.consumer_id, ttl: e.ttl,
                         cluster: e.cluster,
                         enabled: e.enabled, max_get_messages_per_seccond: e.max_get_messages_per_seccond,
